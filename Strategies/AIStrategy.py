        ...
        if not self.position:
            ...
            if self.dataclose[0] >= self.ema200[0]:
                ...
                if self.macd_cross_up and self.psar[0] < self.dataclose[0]:
                    ...
                    oco_profit = self.sell(exectype=bt.Order.Limit, price=self.take_profit, size=amount)
                    oco_loss = self.sell(exectype=bt.Order.Stop, price=self.stop_loss, size=amount, oco=oco_profit)
